  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="bg-white rounded-2xl shadow-sm border p-8 w-full max-w-sm">
        <Link href="/" className="text-indigo-600 font-bold text-lg block mb-6">🧾 InvoiceFlow</Link>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input type="text" placeholder="Business name (optional)" value={form.businessName}
